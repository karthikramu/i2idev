 ...
 */
	...
	//11b1
		...
		function ajaxresult_11b1(){
		 if(!empty($_POST['title'])){
			...
			$title=trim($_POST['title']);
			$title=str_replace(" ", "+", $title); 
			$content=file_get_contents("http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&u=%2Fnetahtml%2FPTO%2Fsearch-adv.htm&r=0&p=1&f=S&l=50&Query=".$title."&d=PTXT");
	...
	/*relevance search*/
	function api_search_15_relevance(){
					...
					if(isset($result_data['cat_invention_1']) && !empty($result_data['cat_invention_1'])){
						...
						iii.	If 6(A) (iii) is chosen, then search Fierceresearch.com. */
							...
							$for_search_part='for_15_1';
									...
									$searchparam = urlencode($searchparam) ; 
								//die("here3");
								$site_content1=file_get_contents("http://seekingalpha.com/search/?source=search_general&q=".$searchparam."&cx=018269914407235029540%3Acdhc2yeo2ko&cof=FORID%3A11%3BNB%3A1&goto_search_tab=general");
